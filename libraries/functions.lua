...
function angleToVector(angle,o,norm,correction)
    local x,y,o,angle,norm,correction=10,0,o or 1,angle or 0,norm or 0, correction or 0
    y=math.tan(angle-correction)*x*o
    return normVector(x,y,norm)
end
